GAME.setupInput = function (state) {
    window.addEventListener('keydown', e => {
        ...
        if (e.key === '9' && state.player.unlockedWeapons.includes('repulsor')) { state.player.weapon = 'repulsor'; GAME.updateHUD(state); }
        ...
        if (e.key.length === 1) {
            ...
            if (state.cheatBuffer.endsWith("admin")) {
                ...
                const cheatWeapons = ['shotgun', 'ar', 'sniper', 'flamethrower', 'railgun', 'nuke', 'gatling', 'repulsor', 'cursorbomb'];
                ...
                GAME.showNotification("CHEAT ENABLED", "ADMIN WEAPONS! Keys 6-Railgun 7-Nuke 8-Gatling 9-Repulsor 0-CursorBomb");
